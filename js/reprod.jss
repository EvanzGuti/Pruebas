...
function obtenercodigoycargarvideo() {
  ...
  contenedorvideo.innerHTML +=
    "<iframe allowfullscreen='' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' frameborder='' height='215px' onload='$('.iframe-loading').css('background-image', 'none');' sandbox='allow-same-origin allow-scripts' scrolling='no' src='https://uqload.org/embed-" +
    videocode +
